...
```{r data import}
rcbd_df <- read_csv("../input/wheat_nk_balkh.csv")
...
# c) Wrangling( factor function overrides)
...
Instead of specifying `nrate_kgha + krate_kgha + nrate_kgha:krate_kgha`,\
